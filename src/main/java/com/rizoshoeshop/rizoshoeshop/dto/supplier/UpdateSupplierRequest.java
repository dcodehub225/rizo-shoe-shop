...
public class UpdateSupplierRequest {
    // ID tidak disertakan di sini karena biasanya ada di URL path atau sebagai parameter
    // dan entitas yang akan diupdate akan ditemukan berdasarkan ID tersebut.
